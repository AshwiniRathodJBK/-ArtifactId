...
public class FacebookLog {
	...
	public FacebookLog(WebDriver driver)
	{
		this.driver = driver;	
		PageFactory.initElements(driver, this);
	}
	
	public FacebookLog(WebDriver driver, ExtentTest test) 
	{
		this.driver=driver;
		this.test=test;
		PageFactory.initElements(driver, this);
	...
	{
		try {
			userName.sendKeys("ashwinirathod1234545656@gmail.com");
			...
			try {
				mediaModel = MediaEntityBuilder.createScreenCaptureFromPath(screenshot("screenshot456.png")).build();
